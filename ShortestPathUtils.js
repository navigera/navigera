...
*/
    ...
    const gridString = "O(4) X(28) O(4) X(20) X(22)\nO(4) 1(1-28) O(4) 1(29-48) X(22)\nO(4) 2(1-23) O(20) 3(1-9) X(22)\nO(4) X(23) O(20) X(31)\nO(4) X(23) O(20) X(31)\nO(4) 4(1-23) O(20) 5(1-31)\nO(4) 6(1-23) O(20) 7(1-25) O(3) 7(29-31)\nO(4) X(23) O(20) X(25) O(3) X(3)\nO(4) X(23) O(20) X(25) O(3) X(3)\nO(4) 8(1-23) O(20) 9(1-25) O(3) 9(29-31)\nO(4) 10(1-23) O(20) 11(1-25) O(3) 11(29-31)\nO(4) X(23) O(20) X(25) O(3) X(3)\nO(4) X(23) O(20) X(25) O(3) X(3)\nO(4) 12(1-23) O(20) 13(1-25) O(3) 13(29-31)\nO(4) 14(1-23) O(20) 15(1-25) O(3) 15(29-31)\nO(4) X(23) O(20) X(25) O(3) X(3)\nO(4) X(23) O(20) X(25) O(3) X(3)\nO(4) 16(1-23) O(20) 17(1-25) O(3) 17(29-31)\nO(4) 18(1-23) O(20) 19(1-25) O(3) 19(29-31)\nO(4) X(23) O(20) X(25) O(3) X(3)\nO(4) X(23) O(20) X(25) O(3) X(3)\nO(4) 20(1-23) O(20) 21(1-25) O(3) 21(29-31)\nO(4) 22(1-23) O(10) 23(1-35) O(3) 23(39-41)\nO(4) X(23) O(10) X(35) O(3) X(3)\nO(4) X(23) O(10) X(35) O(3) X(3)\nO(4) 24(1-23) O(10) 25(1-35) O(3) 25(39-41)\nO(4) 26(1-23) O(10) 27(1-35) O(3) 27(39-41)\nO(4) X(23) O(10) X(35) O(3) X(3)\nO(4) X(23) O(10) X(35) O(3) X(3)\nO(4) 28(1-23) O(10) 29(1-35) O(3) 29(39-41)\nO(4) 30(1-23) O(10) 31(1-35) O(3) 31(39-41)\nO(4) X(23) O(10) X(35) O(3) X(3)\nO(4) X(23) O(10) X(35) O(3) X(3)\nO(4) 32(1-23) O(10) 33(1-35) O(3) 33(39-41)\nO(4) 34(1-20) O(22) 35(1-32)\nO(4) X(20) O(22) X(32)\nO(4) X(20) O(22) X(32)\nO(4) 36(1-20) O(22) 37(1-32)\nO(52) 39(1-26)\nO(52) X(26)\nO(52) X(26)\nO(52) 41(1-26)\nO(72) 43(1-6)"
    ...
    let s = new Date();
    console.log("Time for sorting: ", s-d);
    return sorted;
}
/**
...
function getDistances(currentPackage, modifiedPackageList, grid, distanceGrid) {
    ...
    for (let i = 0; i < modifiedPackageList.length; i++) {
        if (currentPackage.index === i) {
            ...
            if(!isUndefined(distanceGrid, i+1, currentPackage.index+1)){
                distances.push(distanceGrid[i+1][currentPackage.index+1]);
            }else{
